        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto col-7 col-sm-7 col-md-7 col-lg-7 col-xl-7">
              ...
              <li class="nav-item">
                <a class="nav-link" href="HealthServlet?acao=carregarUsuarios">Dashboard</a>
              </li>
            ...
            <div class="col-3 col-sm-3 col-md-3 col-lg-3 col-xl-3">
              <ul class="list-unstyled">
                <li class="nav-item dropdown">
                  <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="imagens/avatar_login.jpg" alt="Informações da Conta" title="Conta do Usuário"></a>
                  <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <a class="dropdown-item" href="HealthServlet?acao=carregarUsuarios">Dashboard</a>
